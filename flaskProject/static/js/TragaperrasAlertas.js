...
function aviso(event) {
    ...
    Swal.fire({
        title: 'Aviso',
        html: "<div style=\'text-align: center;\'>" +
            "Si por algún casual no sabe lo que es tener un razonamiento básico, lea las reglas." +
            '<br> Si pasa algo, no se preocupe, su dinero no se modificará. ' +
            '<br>Cualquier otra cosa, consulte al soporte al cliente. ' +
            '<br>¡Que disfrute jugando la demo!' +
            "</div>",
        icon: 'info',
